...
### Added
- Read brand, model, and size from every Facebook listing carousel photo, and include them in notifications and the found CSV ([#1](https://github.com/crimsonsunset/ai-marketplace-monitor/issues/1))
